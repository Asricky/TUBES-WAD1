        ...
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            <div class="glass p-8 rounded-2xl relative overflow-hidden">
                ...
                <div class="flex items-center justify-between mb-8 relative z-10">
                    <div>
                        <h3 class="text-2xl font-bold text-secondary-900">Formulir Jadwal</h3>
                        <p class="text-secondary-500 text-sm mt-1">Buat jadwal konsultasi baru untuk konselor.</p>
                    </div>
                ...
                <form action="{{ route('schedules.store') }}" method="POST" class="space-y-6 relative z-10">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="time" name="time" id="time" value="{{ old('time') }}" class="w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition-shadow" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="notes" id="notes" rows="3" class="w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition-shadow" placeholder="Catatan tambahan...">{{ old('notes') }}</textarea>
