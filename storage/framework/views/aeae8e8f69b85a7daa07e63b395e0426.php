        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div class="flex items-center justify-between text-white">
                ...
                <div class="text-sm opacity-90">
                    Total: <span class="font-bold"><?php echo e($clients->total() ?? count($clients)); ?></span> Konselor
                </div>
            </div>
        </div>
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">ID: #<?php echo e($client->id); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-gray-700 group-hover:text-gray-900 transition-colors"><?php echo e($client->email); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-2">
                                <i class="fas fa-phone text-gray-400 text-sm"></i>
                                <span class="text-gray-700 group-hover:text-gray-900 transition-colors font-mono"><?php echo e($client->phone); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-2">
                                <i class="fas fa-map-marker-alt text-gray-400 text-sm"></i>
                                <span class="text-gray-700 group-hover:text-gray-900 transition-colors max-w-xs truncate" title="<?php echo e($client->address); ?>">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <form action="<?php echo e(route('clients.destroy', $client)); ?>" method="POST" class="inline-block"
                                      onsubmit="return confirm('⚠️ Apakah Anda yakin ingin menghapus data Konselor <?php echo e($client->name); ?>?\n\nTindakan ini tidak dapat dibatalkan!')">
                                    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="text-sm text-gray-600">
                Menampilkan <span class="font-semibold"><?php echo e($clients->firstItem()); ?></span> - 
                <span class="font-semibold"><?php echo e($clients->lastItem()); ?></span> dari 
                <span class="font-semibold"><?php echo e($clients->total()); ?></span> data
            </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\Kuliah\SEMESTER 4\PENGEMBANGAN APLIKASI WEBSITE\TUBES-WAD1\resources\views/clients/index.blade.php ENDPATH**/ ?>